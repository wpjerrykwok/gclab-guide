...
student-01-f9032019eb62@qwiklabs.net
Copied!
...
When you are connected, you are already authenticated, and the project is set to your Project_ID, qwiklabs-gcp-00-a67175577e95. The output contains a line that declares the Project_ID for this session:

Your Cloud Platform project in this session is set to qwiklabs-gcp-00-a67175577e95
...
ACTIVE: *
ACCOUNT: student-01-f9032019eb62@qwiklabs.net
...
[core]
project = qwiklabs-gcp-00-a67175577e95
...
module "test-vpc-module" {
  ...
  ...
Copied!
In the main.tf file, update the subnet regions on lines 35, 40, and 47 from us-west1 to us-east4. This will ensure that the subnets are created in your project's allowed region. Your module should resemble the following:
  subnets = [
    {
      subnet_name   = "subnet-01"
      subnet_ip     = "10.10.10.0/24"
...
touch variables.tf
Copied!
Add the following code to the variables.tf file. Set the variables project_id and name to default to your Project ID: qwiklabs-gcp-00-a67175577e95.
variable "project_id" {
